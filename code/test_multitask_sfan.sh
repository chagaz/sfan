...
# Two tasks, treated independently
python multitask_sfan.py --num_tasks 2 \
			 ...
			 -l 0.001 -e 0.02 -m 0\
			 --output ../results/results_st_01.runtime.txt \
       > ../results/results_st2_01.txt && cat ../results/results_st2_01.txt && echo && echo



# Two tasks, but no covariance structure is given
python multitask_sfan.py --num_tasks 2 \
                         --networks ../data/simu_01/simu_01.network.dimacs \
                         --node_weights ../data/simu_01/simu_01.scores_0.txt \
                                        ../data/simu_01/simu_01.scores_1.txt \
...
# Two tasks, a single network, given covariance structure
python multitask_sfan.py --num_tasks 2 \
                         --networks ../data/simu_01/simu_01.network.dimacs \
                         --node_weights ../data/simu_01/simu_01.scores_0.txt \
                                        ../data/simu_01/simu_01.scores_1.txt \
...
# Two tasks, two networks, given covariance structure
python multitask_sfan.py --num_tasks 2 \
                         --networks ../data/simu_01/simu_01.network.dimacs \
